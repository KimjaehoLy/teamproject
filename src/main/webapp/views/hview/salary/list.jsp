	...
	<div id="wrapper">
		...
		<div id="search">
			<form action="list" class="searchsmall" name="attSrhFrm">
				...
				<div class="selectInput">
					<input type="text" class="form-control selectac" placeholder="yyyy"
						name="searchDay" id="schYear"/>
				</div>
				<div class="selectInput">
					<input type="text" class="form-control selectac" placeholder="mm"
						name="searchDay" id="schMon"/>
				</div>
		...
		<table class="table table-hover">
			...
			<thead class="thead-dark">
				<tr>
					<th scope="col" colspan="10">${dateYear }년${dateMonth }월</th>
				</tr>
				<tr id="몰라">
					<th scope="col">성명</th>
			...
			<tbody class="thead-light dataBox">
				<c:forEach items="${data }" var="vo">
					<tr>
						...
						<td>
							<!-- 차감지금액 --> <fmt:formatNumber
								value="${vo.user_totPay - vo.user_totPremium}" pattern="0,000원" />
						</td>


						<td><button type="button" class="btn btn-primary btn-sm"
								onclick="location.href='../salary/detail?user_id=${vo.user_id}&user_num=${vo.user_num}&${dateParam }'">
								상세</button>
							<button type="button" class="btn btn-primary btn-sm"
								onclick="location.href='../salary/modify?user_id=${vo.user_id}&${dateParam }'">
								수정</button></td>
					</tr>
				</c:forEach>
				<tr>
