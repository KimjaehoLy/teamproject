...
<hr />
<div class="FFFF">
	<form action="/template/bview/processing/searchF">
		...
		&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
			고객&nbsp;<input type="text" class="form-control" name="customer" /><input
				...
				type="button" onclick="location.href='list'" class="btn btn-outline-info" value="예외" />
		</div>
	</form>
</div>
					...
					<ul class="pagination">
						<c:if test="${startPage>1 }">
							<li class="page-item"><a class="page-link"
								href="?nowPage=${startPage-1 }&o2=${search1 }&customer=${search2}" aria-label="Previous"> <span
						...
						<c:forEach begin="${startPage }" end="${endPage }" step="1"
							...
							<c:choose>
								...
								<c:otherwise>
									<li class="page-item"><a class="page-link"
										href="?nowPage=${i }&o2=${search1 }&customer=${search2}">${i }</a></li>
								</c:otherwise>
							</c:choose>
						</c:forEach>
						<c:if test="${endPage<lastPage }">
							<li class="page-item"><a class="page-link"
								href="?nowPage=${endPage+1 }&o2=${search1 }&customer=${search2}" aria-label="Next"> <span
