...
<div class="FFFF">
	<form action="/template/bview/collect/search">
		<div class="col-lg-14 input-group mb-3">
			...
			<input type="submit" class="btn btn-outline-info" value="조회" />
			&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; 고객&nbsp;<input
				type="text" class="form-control" name="customer" /><input
...
<div class="inform2 off">
	<form class="input-group mb-3 lst" action="updateReg" name="updateT">
		...
		<div class="col-lg-1">
			담당자 <input type="text" class="form-control ll2" name="leader"
				id="lead" placeholder="ex) 김찬범"/>
		</div>
		<div class="col-lg-2">
