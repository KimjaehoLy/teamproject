...
<div class="bottom">
	<table class="table">
		...
		<tr>
      <td colspan="8" align="center"><div class="PPPP">
       	<nav aria-label="Page navigation example">
  			<ul class="pagination">
      	<c:if test="${startPage>1 }">
   			<li class="page-item">
    			<a class="page-link" href="?nowPage=${startPage-1 }&order_num1=${search1 }&customer=${search2}" aria-label="Previous">
         ...
         <c:forEach begin="${startPage }" end="${endPage }" step="1" var="i">
            <c:choose>
               ...
               <c:otherwise>
                  <li class="page-item"><a class="page-link" href="?nowPage=${i }&order_num1=${search1 }&customer=${search2}">${i }</a></li>
               </c:otherwise>
            </c:choose>
         </c:forEach>
      	<c:if test="${endPage<lastPage }">
			<li class="page-item">
			      <a class="page-link" href="?nowPage=${endPage+1 }&order_num1=${search1 }&customer=${search2}" aria-label="Next">
...
<div class="inform2 off">
	<form class="input-group mb-3 lst" action="updateReg" name="updateT">
		...
		<div class="col-lg-2">
			고객 <input type="text" class="form-control cc2" name="customer" id="cus" />
		</div>
		<div class="col-lg-2">
