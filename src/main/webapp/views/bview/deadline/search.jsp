					...
					<ul class="pagination">
						<c:if test="${startPage>1 }">
							<li class="page-item"><a class="page-link"
								href="?nowPage=${startPage-1 }&order_num4=${search1 }&customer=${search2}" aria-label="Previous"> <span
						...
						<c:forEach begin="${startPage }" end="${endPage }" step="1"
							...
							<c:choose>
								...
								<c:otherwise>
									<li class="page-item"><a class="page-link"
										href="?nowPage=${i }&order_num4=${search1 }&customer=${search2}">${i }</a></li>
								</c:otherwise>
							</c:choose>
						</c:forEach>
						<c:if test="${endPage<lastPage }">
							<li class="page-item"><a class="page-link"
								href="?nowPage=${endPage+1 }&order_num4=${search1 }&customer=${search2}" aria-label="Next"> <span
...
<div class="inform1">
	<form class="input-group mb-3 lst" action="inputReg">
		<div class="col-lg-2">
		...
		<div class="col-lg-2">
			<input type="submit" class="btn btn-outline-info btn_1 chks1" value="등록" />
			<input type="reset" class="btn btn-outline-info btn_1" value="초기화" />
		</div>
	</form>
</div>
<div class="inform2 off">
	<form class="input-group mb-3 lst" action="updateReg">
		<div class="col-lg-2">
		...
		<div class="col-lg-2">
			<input type="submit" class="btn btn-outline-info btn_1 chks2" value="수정" />
			<input type="reset" class="btn btn-outline-info btn_1" value="초기화" />
		</div>
	</form>
</div>