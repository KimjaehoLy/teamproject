	...
	<tr>
      ...
      <td colspan="5" align="center">
      	...
      	<c:if test="${startPage>1 }">
   			<li class="page-item">
    			<a class="page-link" href="?nowPage=${startPage-1 }&crre_code=${param.crre_code}" aria-label="Previous">
...
<!-- 입력, 수정 폼 -->
	<div class="off inform" id="inform">
		<form action="/template/jview/correpondent/insertreg"  >
			<table >
				<tr >
					...
					<td width="25%">사업자번호<br><input type="text" name="crre_number" placeholder="숫자 3-2-5 형식" pattern="\d{3}-\d{2}-\d{5}" maxlength="12" required/></td>
		...
		<form action=""  >
			<table >
				<tr >
					...
					<td width="25%">사업자번호<br><input id="mocrre_number" type="text" name="crre_number" pattern="\d{3}-\d{2}-\d{5}" required maxlength="12" /></td>
