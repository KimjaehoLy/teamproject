...
body {
  ...
  background-color: rgb(128, 128, 192,0.4);
}
body .container {
  position: relative;
  overflow: hidden;
			        ...
			        <div class="content">
				            <div class="signin-cont cont">
					                <form action="/login/reg" method="post" >
						                    ...
						                    <input type="text" name="acce_id" id="pid" class="inpt" required="required" placeholder="Your id">
                						    <label for="password">Your password</label>						                 
						                    <input type="password" name="acce_pw" id="password" class="inpt" required="required" placeholder="Your password">
