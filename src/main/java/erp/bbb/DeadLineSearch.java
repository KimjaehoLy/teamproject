...
@Service("deadlinesearch")
public class DeadLineSearch implements Action{
	...
	public Object execute(HashMap<String, Object> map, HttpServletRequest req) {
		...
		DeadLineVO dvo = (DeadLineVO)map.get("dvo");

		pag.setSearch1(dvo.order_num4);
		pag.setSearch2(dvo.customer);
		
		SearchVO ssv = new SearchVO();
		ssv.setSearch1(dvo.order_num4);
		ssv.setSearch2(dvo.customer);
